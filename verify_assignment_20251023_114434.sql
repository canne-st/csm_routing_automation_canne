...
WHERE account_id = '0011a00000WVohCAAT'
    AND run_id = '20251023_114434';
...
WHERE active_csm = 'Gohar Grigoryan';
...
WHERE csm_name = 'Gohar Grigoryan';
...
SET was_assigned = TRUE,
    actual_assigned_csm = 'Gohar Grigoryan'
WHERE account_id = '0011a00000WVohCAAT'
    AND run_id = '20251023_114434';
...
USING (
    SELECT
        '0011a00000WVohCAAT' as account_id,
        'Gohar Grigoryan' as csm_name,
